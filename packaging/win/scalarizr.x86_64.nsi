...
Section "MainSection" SEC01
  ...
  ${IfNot} ${FileExists} "$INSTDIR\Python26"
  	File /r /x *.svn* /x *.pyc /x *.pyo "x86_64\Python26"
  ${EndIf}
...
Section -PostInstall
  ...
  SetEnv::SetEnvVar "PYTHONPATH" $R0
	...
	${If} $installed_version == ""
		...
		${If} ${RunningX64}
		  ${DisableX64FSRedirection}
		  nsExec::ExecToStack '"$INSTDIR\Python26\python.exe" "$INSTDIR\Python26\scripts\pywin32_postinstall.py" -install'
		  ${EnableX64FSRedirection}
		${Else}

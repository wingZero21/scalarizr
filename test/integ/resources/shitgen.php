...
T;
	...
	if ($args['t']) {
		...
		$min_blob_size = 1024; // 1Kb
		$max_blob_size = 64 * $min_blob_size; // 64Kb
	} else {
		$max_table_size = 512 * 1024 * 1024; // 512Mb
		$min_blob_size = 64 * 1024; // 64Kb
	...
	$blob_filename = tempnam("/tmp", "blob.");

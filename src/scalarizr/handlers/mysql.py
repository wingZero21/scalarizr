			...
			if "mysql_master" == role_name:
				...
				# If EBS volume had mysql dirs (N-th init)
					...
					try:
						...
						self._logger.error('Cannot retrieve mysql login and password from config: %s', e)
						raise

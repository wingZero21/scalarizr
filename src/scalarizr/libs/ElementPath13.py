...
Bundled ElementPath module from ElementTree 1.3 branch
Added several patches:
1. Patched 'select' functions to work with el.iterator()
2. Added support for node position (removed [tag] support) 
"""
...
# 2010-07-01      patched to work with ElementTree 1.2
# 2010-07-01      added support for node position
#
